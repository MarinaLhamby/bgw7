...
import (
	...
	"github.com/bgw7/exercicio_1_2_auth_response/pkg/web/response"
)
...
func NewProductJsonRepository(storage storage.Storage, productsList []domain.Product) *ProductJsonRepository {
