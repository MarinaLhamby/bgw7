...
func (h *ProductsDefault) GetTopFiveBestSellers() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		bestSellers, err := h.sv.GetTopFiveBestSellers()
		if err != nil {
			response.Error(w, http.StatusInternalServerError, "error getting products best sellers")
			return
		}
